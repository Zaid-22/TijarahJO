...
.PHONY: help \
	...
	verify smoke backend-integration frontend-contract \
	backend-build backend-test frontend-lint frontend-test frontend-build \
...
help:
	...
	@echo "  make backend-integration # Run backend integration contract checks"
	...
	@echo "  make quality-gates       # structure-check + lint/build/test gates"
	@echo "  make contracts-check     # backend-integration + frontend-contract"
	@echo "  make full-check          # quality-gates"
