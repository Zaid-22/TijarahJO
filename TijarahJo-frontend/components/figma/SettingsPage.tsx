...
export function SettingsPage({ 
  ...
  return (
    <div className="min-h-screen dark:bg-[#1a1a1a]" style={{ backgroundColor: "#F5F6FA" }}>
      {/* Header */}
      <header className="sticky top-0 z-50 shadow-sm dark:bg-[#111111]" style={{ backgroundColor: "#0A4ABF" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16 gap-4">
            ...
            >
              <ArrowLeft className={`w-5 h-5 ${isRTL ? 'rotate-180 mr-2' : 'mr-2'}`} />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="space-y-4 sm:space-y-6">
          ...
          <Card>
            <CardHeader>
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                <div className="flex items-center gap-3 flex-1 w-full sm:w-auto">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "#0A4ABF" + "20" }}>
                    <User className="w-5 h-5" style={{ color: "#0A4ABF" }} />
                  </div>
                  <div className="flex-1 min-w-0">
                    <CardTitle>{text.accountSettings}</CardTitle>
                    <CardDescription className="break-words">{text.accountDesc}</CardDescription>
                  </div>
                </div>
                <Button 
                  variant="outline" 
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="dark:text-white">{userProfile.name}</div>
              </div>
              <Separator />
              <div className="space-y-2">
                <Label className="text-sm opacity-60">{text.username}</Label>
                <div className="dark:text-white">{userProfile.username}</div>
              </div>
              <Separator />
              <div className="space-y-2">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: "#FF6347" + "20" }}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">{text.messageNotificationsDesc}</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch checked={newListingNotifications} onCheckedChange={setNewListingNotifications} />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: "#32CD32" + "20" }}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" style={{ color: "#0A4ABF", borderColor: "#0A4ABF" }}>
                  {text.enable}
                </Button>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: "#FF69B4" + "20" }}>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: "#8B4513" + "20" }}>
                  <HelpCircle className="w-5 h-5" style={{ color: "#8B4513" }} />
                </div>
                <div>
