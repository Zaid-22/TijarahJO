...
BEGIN TRY
    ...
    -- Guard against re-creation: BASE_SCHEMA.sql creates this table on a clean DB,
    -- so when master.sql appends migrations after the base schema we must be idempotent.
