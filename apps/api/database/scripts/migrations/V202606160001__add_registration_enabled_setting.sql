...
BEGIN TRY
    ...
    IF NOT EXISTS (
        ...
        WHERE ScriptName = N'V202606160001__add_registration_enabled_setting'
    )
    BEGIN
        INSERT INTO dbo.SchemaMigrations (ScriptName, Notes)
        VALUES (
            N'V202606160001__add_registration_enabled_setting',
            N'Seed RegistrationEnabled=true into SystemSettings if the table exists.'
        );
    END
