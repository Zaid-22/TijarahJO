...
public static class PasswordHelper
{
    ...
    // Current strategy: PBKDF2 with per-password random salt.
    ...
    // Legacy strategy kept for backward compatibility with old records.
    ...
    public static bool VerifyPassword(string password, string hashedPassword)
    {
        ...
        // Transitional compatibility for deterministic peppered-hash deployments.
