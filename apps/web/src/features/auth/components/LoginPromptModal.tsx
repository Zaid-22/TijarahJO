...
export function LoginPromptModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        className="sm:max-w-md p-0 overflow-hidden bg-transparent border-0 shadow-none w-[95vw] sm:w-full max-h-[90vh] overflow-y-auto [&>button]:hidden flex flex-col justify-start sm:justify-center items-center" 
        dir={isRTL ? "rtl" : "ltr"}
      >
