export const marketplaceTranslations = {
  en: {
    ...
    noFavoritesDescription: "Start adding items to your favorites to see them here. Click the heart icon on any post to save it.",
  ...
  ar: {
    ...
    noFavoritesDescription: "ابدأ بإضافة العناصر إلى المفضلة لتظهر هنا. اضغط على أيقونة القلب في أي منشور للحفظ.",
