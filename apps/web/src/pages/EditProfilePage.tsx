...
const debugProfileLog = (...args: unknown[]) => {
  if (DEBUG_PROFILE) {
    console.log(...args);
  }
};
...
export function EditProfilePage({
  ...
  const handleChange = (field: keyof UserProfile, value: string | number) => {
    ...
    if (
      ...
      const middleName =
        field === "middleName" ? (value as string) : formData.middleName || "";
      const lastName =
  ...
  const handleSave = () => {
    ...
    if (!formData.area || formData.area.trim() === "") {
      newErrors.area = language === "ar" ? "المنطقة مطلوبة" : "Area is required";
    }

    // Phone is required and must be in valid Jordanian format (+962 + 9 digits)
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  >
                    <SelectValue
                      placeholder={t.selectCity || "Select your city"}
                    />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder={
                    t.enterBio || "Tell us about yourself and what you sell..."
                  }
                  rows={4}
                  maxLength={500}
                />
            ...
            <CardContent>
              <div className="grid grid-cols-1 gap-4">
                <div className="text-center p-4 rounded-lg bg-gray-100 dark:bg-gray-800">
                  ...
                  <div style={{ color: "#0A4ABF" }}>{formData.joinedDate}</div>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <Button
              ...
              disabled={!hasChanges}
              style={{
                backgroundColor: hasChanges ? "#0A4ABF" : "#E5E7EB",
